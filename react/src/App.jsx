...
function App() {
  ...
  return (
    <>
      ...
      {/* Modal */}
      {showModal && (
        <div id="popup_modal" tabIndex="-1" className="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50">
          <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-4 md:p-5 text-center">
                ...
                <h3 className="mb-1 text-lg font-normal text-gray-500 dark:text-gray-400">No face detected.</h3>
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Please upload another image.</h3>
                <button
                  onClick={closeModal} // Attach the close modal event handler
                  type="button"
