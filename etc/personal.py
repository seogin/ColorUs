...
# Load dataset
dataset = PersonalColorDataset(root_dir='./ab', transform=train_transform)
...
test_dataset = Subset(PersonalColorDataset(root_dir='./ab', transform=test_transform), test_indices)
